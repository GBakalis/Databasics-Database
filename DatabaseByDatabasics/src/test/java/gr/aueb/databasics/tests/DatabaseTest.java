...
public class DatabaseTest {
	...
	public void testCopyExistingEntry() {
		...
		for (int i = 1; i < table.getAttributeNumber() - 2; i++) {
			Assert.assertEquals("Wrong copy results", table.getAttributes(i).getArray().get(0), table2.getAttributes(i).getArray().get(0));
	...
	public void testCopyNewEntry() {
		...
		for (int i = 1; i < table.getAttributeNumber() - 2; i++) {
			Assert.assertEquals("Wrong copy results", table.getAttributes(i).getArray().get(0), table2.getAttributes(i).getArray().get(4));
	...
	public void testCopyExistingAttribute() {
		...
		public void testCopyNewAttribute() {
			...
			for (int i = 0; i < table.getAttributes(1).getArray().size(); i++) {
				Assert.assertEquals("Wrong copy results",table.getAttributes(1).getArray().get(i), table2.getAttributes(5).getArray().get(i));
			}
		}
